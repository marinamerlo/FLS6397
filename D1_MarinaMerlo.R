...
##DÚVIDA: faz sentido agregar por candidato, se cada candidato só tem voto dentro do seu município?
#parece que essa etapa seria pra eleições gerais, não municipais
#no final, cada candidato tem 100% da sua votação em cada municipio.
